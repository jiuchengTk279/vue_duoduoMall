...
#### 十七、改造图片分析 按钮为 路由的链接并显示对应的组件页面


#### 十八、绘制 图片列表 组件页面结构并美化样式
 1. 制作 顶部的滑动条
 2. 制作 底部的图片列表
...
#### 二十一、实现了 图片列表的 懒加载改造和 样式美化

#### 二十二、实现了 点击图片 跳转到 图片详情页面
1. 在改造 li 成 router-link 的时候，需要使用 tag 属性指定要渲染为 哪种元素

#### 二十三、实现 详情页面的布局和美化，同时获取数据渲染页面
...
#### 二十五、 绘制 商品列表 页面基本结构并美化

#### 二十六、 尝试在手机上 去进行项目的预览和测试
1. 要保证自己的手机可以正常运行；
